...
export default async function PrayerTimesPage() {
  ...
  return (
    <main className="min-h-screen pb-40 bg-transparent font-sans selection:bg-emerald-200 transition-colors duration-300">
      ...
      <div className="sticky top-0 z-40 bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-900 text-white pt-6 pb-8 px-8 rounded-b-[3.5rem] shadow-[0_20px_40px_-15px_rgba(4,120,87,0.5)] relative overflow-hidden text-center mb-6">
      ...
      <div className="px-6 pt-10 flex flex-col gap-5 max-w-md mx-auto relative z-20">
        {times.map((pt, idx) => {
          ...
          return (
            <div key={idx} className={`rounded-[2rem] p-6 bg-[var(--card-bg)] shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] border border-[var(--card-border)] relative overflow-hidden flex flex-col justify-center animate-in fade-in slide-in-from-bottom-5 duration-700 fill-mode-both`} style={{animationDelay: `${idx * 100}ms`}}>
               {pt.extra && (
