...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { name: "Admin", href: "/admin", icon: <Settings size={32} /> },
  ];
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 pb-safe">
      <div className="bg-white/90 backdrop-blur-2xl border-t border-gray-200/50 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] 
                      rounded-t-[2.5rem] px-6 py-4 flex justify-between items-center max-w-md mx-auto h-[100px]">
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={clsx(
                ...
                isActive ? "text-emerald-600 bg-emerald-50 shadow-sm" : "text-gray-400 hover:text-emerald-500"
              )}
            >
